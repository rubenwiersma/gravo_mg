...
if __name__ == "__main__":
    ...
    parser.add_argument('--ratio', type=float, default=8, help='Decay of density for hierarchy construction (default: 8)')
    parser.add_argument('--lower_bound', type=int, default=1000, help='Minimum number of points in the lowest level (default: 1000)')
    ...
    parser.add_argument('--in_dir', type=str, default='../../data/final', help='Directory to run benchmark on, relative to this script (default: ../../data/final)')
    ...
    parser.add_argument('--num_repetitions', type=int, default=1, help='Number of repeated constructions and solves to average (default: 1)')
    ...
    parser.add_argument('--input_smooth', action='store_true', help='Uses smoothed noise as right hand side')
    ...
    parser.add_argument('--nonmanifold', action='store_true', help='Uses robust Laplacian and only runs methods that support non-manifold meshes')
    parser.add_argument('--all_triangles', action='store_true', help='Considers all triangles in the 1-ring, instead of only Voronoi neighbors')
    parser.add_argument('--nested', action='store_true', help='Maintains point positions throughout hierarchy instead of shifting to barycenters of clusters')
    ...
    parser.add_argument('--sampling', type=str, default='fastdisk', choices=['fastdisk', 'poissondisk', 'random', 'fps', 'mis'], help='Sampling method to use (default: fastdisk)')
    parser.add_argument('--weighting', type=str, default='barycentric', choices=['barycentric', 'uniform', 'invdist'], help='Weighting method to use (default: barycentric)')
